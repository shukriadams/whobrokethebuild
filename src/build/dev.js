...
(async function(){
    ...
    let sassWatcher = chokidar.watch(['./client/app/**/*.scss', './server/frontend/**/*.scss'], {
        persistent: true,
        usePolling: true,
    ...
    sassWatcher
        ...
        .on('unlink', async function(file){
            ...
            // start watching sass files
    let jsWatcher = chokidar.watch(['./server/frontend/**/*.js'], {
        persistent: true,
        usePolling: true,
        ignoreInitial : isFast
    })
    ...
    let expressWatcher = chokidar.watch(['./index.js', './server/**/*.js', '!./server/frontend/**', '!./data/**', '!**/node_modules/**' ], {
        persistent: true,
        usePolling: true,
